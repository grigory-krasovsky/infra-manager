 ...
 *
 * <p>Задачи никуда не двигают карточку: колонка определяется вердиктом ревьюера о
 * нынешней голове ветки и только им. Они попадают в карточку чек-листом, чтобы было
 * видно, что именно просили и что из этого уже закрыто.
 *
